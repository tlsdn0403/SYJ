...
PROTOBUF_CONSTEXPR DespawnInfo::DespawnInfo(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.object_id_)*/uint64_t{0u}
  , /*decltype(_impl_.object_type_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct DespawnInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DespawnInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~DespawnInfoDefaultTypeInternal() {}
  union {
    DespawnInfo _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DespawnInfoDefaultTypeInternal _DespawnInfo_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::ObjectInfo, _impl_.weapon_type_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ObjectInfo, _impl_.nickname_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::DespawnInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::DespawnInfo, _impl_.object_id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::DespawnInfo, _impl_.object_type_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::PosInfo)},
  { 14, -1, -1, sizeof(::Protocol::ObjectInfo)},
  { 25, -1, -1, sizeof(::Protocol::DespawnInfo)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Protocol::_PosInfo_default_instance_._instance,
  &::Protocol::_ObjectInfo_default_instance_._instance,
  &::Protocol::_DespawnInfo_default_instance_._instance,
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\002\022\014\n\004roll\030\010 \001(\002\"\226\001\n\nObjectInfo\022\021\n\tobj"
  "ect_id\030\001 \001(\004\022)\n\013object_type\030\002 \001(\0162\024.Prot"
  "ocol.ObjectType\022#\n\010pos_info\030\003 \001(\0132\021.Prot"
  "ocol.PosInfo\022\023\n\013weapon_type\030\004 \001(\005\022\020\n\010nic"
  "kname\030\005 \001(\t\"K\n\013DespawnInfo\022\021\n\tobject_id\030"
  "\001 \001(\004\022)\n\013object_type\030\002 \001(\0162\024.Protocol.Ob"
  "jectTypeb\006proto3"
  ;
...
ObjectInfo::ObjectInfo(const ObjectInfo& from)
  ...
  ::memcpy(&_impl_.object_id_, &from._impl_.object_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.weapon_type_) -
    reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.weapon_type_));
...
void ObjectInfo::InternalSwap(ObjectInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ObjectInfo, _impl_.weapon_type_)
      + sizeof(ObjectInfo::_impl_.weapon_type_)
...
class DespawnInfo::_Internal {
 public:
};

DespawnInfo::DespawnInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.DespawnInfo)
}
DespawnInfo::DespawnInfo(const DespawnInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  DespawnInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.object_id_){}
    , decltype(_impl_.object_type_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.DespawnInfo)
}

inline void DespawnInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
DespawnInfo::~DespawnInfo() {
  // @@protoc_insertion_point(destructor:Protocol.DespawnInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void DespawnInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void DespawnInfo::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void DespawnInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.DespawnInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* DespawnInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* DespawnInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.DespawnInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.DespawnInfo)
  return target;
}

size_t DespawnInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.DespawnInfo)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData DespawnInfo::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    DespawnInfo::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*DespawnInfo::GetClassData() const { return &_class_data_; }


void DespawnInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<DespawnInfo*>(&to_msg);
  auto& from = static_cast<const DespawnInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.DespawnInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void DespawnInfo::CopyFrom(const DespawnInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.DespawnInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool DespawnInfo::IsInitialized() const {
  return true;
}

void DespawnInfo::InternalSwap(DespawnInfo* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DespawnInfo, _impl_.object_type_)
      + sizeof(DespawnInfo::_impl_.object_type_)
      - PROTOBUF_FIELD_OFFSET(DespawnInfo, _impl_.object_id_)>(
          reinterpret_cast<char*>(&_impl_.object_id_),
          reinterpret_cast<char*>(&other->_impl_.object_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata DespawnInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Struct_2eproto_getter, &descriptor_table_Struct_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::DespawnInfo*
Arena::CreateMaybeMessage< ::Protocol::DespawnInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::DespawnInfo >(arena);
}
